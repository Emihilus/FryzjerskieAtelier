                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void unused) {
                                if(result) {
                                    Toast.makeText(getContext(),"Logowanie pomyślne", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(getContext(),"Logowanie niepomyślne, spróbuj ponownie", Toast.LENGTH_LONG).show();
